            ...
            <div class="flex items-center gap-2 ml-auto">
                ...
                @else
                    <a href="{{ url('/favorit') }}" title="Favorit"
                       class="grid place-items-center w-9 h-9 rounded-full text-gray-400 hover:text-relove-500 hover:bg-relove-50 transition text-lg">🤍</a>
                    ...
                    <details class="relative">
                        ...
                        <div class="absolute right-0 mt-2 w-56 bg-white rounded-xl shadow-lg border border-gray-100 py-2 text-sm z-50">
                            ...
                            <a href="{{ url('/favorit') }}" class="flex items-center gap-2 px-4 py-2 text-gray-600 hover:bg-relove-50 hover:text-relove-600">Favorit</a>
